      ...
      <div class="modal-content">
        ...
        <form #h="ngForm">
          <div class="container-fluid" style="padding: 0;">
            ...
            <div *ngIf="(this.filtriService.attivaView == 'articolo' && !this.filtriService.mostraGEV)" style="margin: 1em auto 0;">
              ...
              <div class="row mt-3" style="justify-content: end; padding-left: 1em; padding-right: 1em;">
                <div class="animate__animated animate__fadeIn" [hidden]="h.invalid">
                  <button id="bottoneSalva" type="submit" class="btn btn-primary w-100" (click)="editProdotto.emit(h)"> CONFERMA </button>
                </div>
              ...
              <div *ngIf="insNuovo">
                ...
                <div class="container" style="padding: 0;">
                  <div class="row" style="margin: 2em 0 2em;">
                    ...
                    <!-- Lista Barcodes -->
                    <div id="cardListaBarcodes" class="card" *ngIf="!this.filtriService.zeroBarcodes && !this.filtriService.editBcodeAttiva && !this.filtriService.addBcodeAttiva">
                      <div class="card-body">
                    ...
                    <div id="cardListaBarcodes" class="card" *ngIf="this.filtriService.addBcodeAttiva">
                      <div class="card-body">
                        ...
                        <form #j="ngForm">
                          ...
                          <div class="row mb-2">
                            <div class="col-8">
                              <div class="input-group flex-nowrap" style="margin-top: 3em;">
                            ...
                            <div class="col-4" style="padding-left: 0;">
                              <div class="input-group flex-nowrap" style="margin-top: 3em; margin-bottom: 2em;">
                                <span class="input-group-text" id="addon-wrapping">
              ...
              <div *ngIf="!insNuovo">
                ...
                <div class="container" style="padding: 0;">
                  <div class="row" style="margin: 2em 0 2em;">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="currentColor" class="bi bi-gear-wide-connected" viewBox="0 0 16 16">
                    ...
                    <div id="cardListaBarcodes" class="card" *ngIf="!this.filtriService.zeroBarcodes && !this.filtriService.editBcodeAttiva && !this.filtriService.addBcodeAttiva">
                      <div class="card-body">
                        <table class="table table-hover table-borderless align-middle" style="margin-bottom: 0;">
                          <thead>
                            <tr>
                              <th scope="col" class="text-start" style="width: 70%;"><label>Barcode</label></th>
                              <th scope="col" class="text-start" style="width: 30%;"><label>Confezione</label></th>
                            </tr>
                          </thead>
                          <tbody>
                            <tr *ngFor="let bcF of this.filtriService.barcodesFiltrati" style="cursor: pointer;" (click)="settaEditBcode.emit(bcF)">
                              <td>
                                <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-upc" viewBox="0 0 16 16">
                                  <path d="M3 4.5a.5.5 0 0 1 1 0v7a.5.5 0 0 1-1 0v-7zm2 0a.5.5 0 0 1 1 0v7a.5.5 0 0 1-1 0v-7zm2 0a.5.5 0 0 1 1 0v7a.5.5 0 0 1-1 0v-7zm2 0a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-7zm3 0a.5.5 0 0 1 1 0v7a.5.5 0 0 1-1 0v-7z"/>
                                </svg>
                    ...
                    <div id="cardListaBarcodes" class="card" *ngIf="this.filtriService.addBcodeAttiva">
                      <div class="card-body">
                        ...
                        <form #j="ngForm">
                          ...
                          <div class="row mb-2">
                            <div class="col-8">
                              <div class="input-group flex-nowrap" style="margin-top: 4em; margin-bottom: 2em;">
                                <span class="input-group-text" id="addon-wrapping">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-upc" viewBox="0 0 16 16">
                                    <path d="M3 4.5a.5.5 0 0 1 1 0v7a.5.5 0 0 1-1 0v-7zm2 0a.5.5 0 0 1 1 0v7a.5.5 0 0 1-1 0v-7zm2 0a.5.5 0 0 1 1 0v7a.5.5 0 0 1-1 0v-7zm2 0a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-7zm3 0a.5.5 0 0 1 1 0v7a.5.5 0 0 1-1 0v-7z"/>
                                  </svg>
                            ...
                            <div class="col-4" style="padding-left: 0;">
                              <div class="input-group flex-nowrap" style="margin-top: 4em;">
                                <span class="input-group-text" id="addon-wrapping">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="22" height="35" fill="currentColor" class="bi bi-archive" viewBox="0 0 16 16">
                                    <path d="M0 2a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1v7.5a2.5 2.5 0 0 1-2.5 2.5h-9A2.5 2.5 0 0 1 1 12.5V5a1 1 0 0 1-1-1V2zm2 3v7.5A1.5 1.5 0 0 0 3.5 14h9a1.5 1.5 0 0 0 1.5-1.5V5H2zm13-3H1v2h14V2zM5 7.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5z"/>
                                  </svg>
            ...
            <!-- Contenuto maschera di cancellazione articolo -->
            <div *ngIf="this.filtriService.attivaView == 'cancella' && !insNuovo">
              <div class="container" style="padding: 0;">
                <div class="row" style="margin: 2em 0 2em;">
                    ...
                    <div class="card-body">
                      ...
                      <div class="row mb-2" style="text-align: center; font-size: 1.1rem; margin-top: 2em;">
                        <div class="col-12">
                          <p style="font-size: 1.2rem;">Sei sicuro di voler eliminare
                            <br>
                            <span style="font-weight: 700;" *ngIf="!this.filtriService.mostraGEV">{{this.filtriService.tabacchiAttivo.descrizione }} ?</span>

                            <span style="font-weight: 700;" *ngIf="this.filtriService.mostraGEV">{{this.filtriService.GEVAttivo.descrizione }} ?</span>
                          </p>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="modal-footer" style="border: none; padding-bottom: 0;">
                          <button id="bottoneElimina" type="button" class="btn btn-light w-100" data-bs-dismiss="modal" (click)="delProdotto.emit(this.filtriService.tabacchiAttivo)" *ngIf="!this.filtriService.mostraGEV"> ELIMINA </button>

                          <button id="bottoneElimina" type="button" class="btn btn-light w-100" data-bs-dismiss="modal" (click)="delGEV.emit(this.filtriService.GEVAttivo)" *ngIf="this.filtriService.mostraGEV"> ELIMINA </button>
                        </div>
                      </div>
                    </div>
                  </div>
