...
export class HomeComponent implements OnInit {
  ...
  constructor( private httpClient: HttpClient, public authService: AuthService, public toastr: ToastrService, public notificheService: NotificheService, public filtriService: FiltriService) { }
